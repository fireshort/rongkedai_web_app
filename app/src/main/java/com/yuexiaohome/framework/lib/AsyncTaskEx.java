package com.yuexiaohome.framework.lib;
...
public abstract class AsyncTaskEx<Params,Progress,Result>
{
    ...
    protected void onFailure(Exception reason)
    {
        Log.e(LOG_TAG,"AsyncTask has been failed!",reason);
    }
     ...
     * typically because it has already onCompleted normally;
     ...
     *                               {@link android.os.AsyncTask.Status#RUNNING} or {@link
     ...
     * AsyncTask, however you can also use your own {@link java.util.concurrent.Executor} for
     * custom
     * behavior.
     * <p/>
